...
export class qAndA1707906615532 implements MigrationInterface {
    name = 'qAndA1707906615532'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`q_and_answer\` (\`id\` int NOT NULL AUTO_INCREMENT, \`message\` varchar(255) NOT NULL, \`created\` varchar(255) NOT NULL, \`updated\` varchar(255) NOT NULL, \`id_response\` int NOT NULL, \`usersId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`question_and_a\` (\`id\` int NOT NULL AUTO_INCREMENT, \`label\` varchar(255) NOT NULL, \`created\` varchar(255) NOT NULL, \`updated\` varchar(255) NOT NULL, \`id_user\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`general_question\` DROP COLUMN \`label\``);
        await queryRunner.query(`ALTER TABLE \`general_question\` ADD \`label\` varchar(255) NOT NULL`);
        await queryRunner.query(`DROP TABLE \`question_and_a\``);
        await queryRunner.query(`DROP TABLE \`q_and_answer\``);
