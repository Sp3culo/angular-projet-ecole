...
export class generalKnowledgeDate1710680596000 implements MigrationInterface {
    name = 'generalKnowledgeDate1710680596000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`general_question\` ADD \`created\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`general_question\` DROP COLUMN \`updated\``);
        await queryRunner.query(`ALTER TABLE \`general_question\` ADD \`updated\` datetime NOT NULL`);
