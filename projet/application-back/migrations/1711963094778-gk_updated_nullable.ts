...
export class gkUpdatedNullable1711963094778 implements MigrationInterface {
    name = 'gkUpdatedNullable1711963094778'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`general_response\` ADD \`created\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`general_response\` DROP COLUMN \`updated\``);
        await queryRunner.query(`ALTER TABLE \`general_response\` ADD \`updated\` datetime NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`general_question\` CHANGE \`updated\` \`updated\` datetime NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`username\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`username\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`general_question\` CHANGE \`updated\` \`updated\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`general_question\` DROP COLUMN \`label\``);
        await queryRunner.query(`ALTER TABLE \`general_question\` ADD \`label\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`general_response\` DROP COLUMN \`updated\``);
